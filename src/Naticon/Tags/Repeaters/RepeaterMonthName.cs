...
namespace Naticron.Tags.Repeaters
{
	...
	{
		private const int SecondsInMonth = 2592000; // 30 days * 24 h * 60 min * 60 sec
		...
		public int GetMonthIndex() => (int) Value;

		public override Span GetOffset(Span span, int amount, Pointer.Type pointer) => throw new IllegalStateException("Not implemented.");

		public override int GetWidth() => SecondsInMonth;

		public override string ToString() => base.ToString() + "-monthname-" + Value;

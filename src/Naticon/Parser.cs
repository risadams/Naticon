...
namespace Naticon
{
	public class Parser
	{
		...
		private readonly HandlerRegistry _registry = new MyHandlerRegistry();
		...
		public Span Parse(string phrase) => Parse(phrase, _options);
		...
		private static Span ExecuteHandler(ComplexHandler handler, IList<Token> tokens, Options options)
		{
			if (handler == null)
			{

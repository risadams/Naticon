...
namespace Naticron
{
	...
	{
		private static readonly dynamic[,] BIG_PREFIXES =
		{
			{"hundred", 100},
			{"thousand", 1000},
			{"million", 1000000},
		...
		private static readonly dynamic[,] DIRECT_NUMS =
		{
			{"eleven", "11"},
			{"twelve", "12"},
			{"thirteen", "13"},
		...
		private static readonly dynamic[,] ORDINALS =
		{
			{"first", "1"},
			{"third", "3"},
			{"fourth", "4"},
		...
		private static readonly dynamic[,] TEN_PREFIXES =
		{
			{"twenty", 20},
			{"thirty", 30},
			{"forty", 40},

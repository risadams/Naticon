...
namespace Naticon.Tests.Parsing
{
	...
	{
		private static readonly DateTime Date = new DateTime(2011, 10, 18);
		private static readonly TimeSpan TimeOfDay = new TimeSpan(15, 34, 44);

		protected override DateTime Now() => Date.Add(TimeOfDay);

...
namespace Naticon.Tests.Parsing
{
	...
	{
		protected override DateTime Now() => Time.New(2006, 8, 16, 14, 0, 0);
		...
		public void rmn_od_sy()
		{
			...
			Parse("November 18th 2010 at 4", new {AmbiguousTimeRange = 0}).AssertEquals(Time.New(2010, 11, 18, 4));
			...
			Parse("March 30th 79 at 4:30", new {AmbiguousTimeRange = 0}).AssertEquals(Time.New(1979, 3, 30, 4, 30));
		}
		...
		public void rmn_sd_sy()
		{
			...
			Parse("may 27 79 at 4:30", new {AmbiguousTimeRange = 0}).AssertEquals(Time.New(1979, 5, 27, 4, 30));
